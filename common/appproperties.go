...
import (
	...
	"github.com/bjshujie/gooxml/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/bjshujie/gooxml")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/bjshujie/gooxml
